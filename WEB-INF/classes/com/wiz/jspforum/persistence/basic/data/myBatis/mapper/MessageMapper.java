...
/**
 * The interface MAPPER of myBatis for Message is assigned to handle with all the operations to the data record in database
 */
public interface MessageMapper {
	...
	/**
	 * Update the fields of FORUM_MESSAGE record for Read Flag base on the input DTO
	 * 
	 * @param message the DTO of user message entity
	 */
	void updateUserMessageRecordForReadFlag(UserMessage message);
	/**
	 * Insert a new record to FORUM_MESSAGE base on the input DTO
	 * 
	 * @param message the DTO of user message entity
	 */
	void insertUserMessageRecord(UserMessage message);
	/**
