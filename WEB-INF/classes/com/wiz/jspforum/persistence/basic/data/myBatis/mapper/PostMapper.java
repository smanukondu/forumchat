...
/**
 * The interface MAPPER of myBatis for Post is assigned to handle with all the operations to the data record in database
 */
public interface PostMapper {
	 ...
	 */
	List<UserPost> getUserPostRecordsWithConditions(String conditions);
	/**
