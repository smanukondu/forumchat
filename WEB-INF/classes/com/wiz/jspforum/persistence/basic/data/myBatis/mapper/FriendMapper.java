...
/**
 * The interface MAPPER of myBatis for Friend is assigned to handle with all the operations to the data record in database
 */
public interface FriendMapper {
	 ...
	 */
	void updateFriendJointRequestRecordForRequestStatus(FriendJointRequest fjr);
	/**
	 * Insert a new record into FORUM_FRIEND_REQUEST
	 * 
	 * @param fri the DTO of friend request entity
	 */
	void insertFriendJointRequestRecord(FriendJointRequest fjr);
	/**
	 ...
	 */
	void insertFriendLinkRecord(FriendLink fl);
	/**
	 ...
	 */
	FriendJointRequest getFriendJointRequestRecordByFriendRequestId(int friendJointRequestId);
	/**
	 * Delete the record from FORUM_FRIEND_MAP
	 * 
	 * @param fl the DTO of friend link entity
	 */
	void deleteFriendLinkRecord(FriendLink fl);
	/**
