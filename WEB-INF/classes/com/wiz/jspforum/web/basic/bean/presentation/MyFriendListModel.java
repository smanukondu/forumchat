...
/**
 * The present bean of the Friend Linked List
 */
public class MyFriendListModel extends PagingListModel<UserProfile> implements Serializable {

	private static final long serialVersionUID = -5739838537344909532L;
	...
	public MyFriendListModel(List<UserProfile> dataList) {
		super();
