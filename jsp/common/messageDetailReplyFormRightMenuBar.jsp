...
<table style="width: 100%; padding: 4;">
	<tr>
		<td style="border-bottom: 1px solid #CCCCCC" height="20px">
			<div class="index"><strong><s:message code="template00.messageInDetailForm.rightMenubarTitle.LABEL"/></strong></div>
		</td>
	</tr>
	<tr>
		<td style="border-bottom: 1px solid #CCCCCC" height="40px">
			<div class="index">
				<a href="<c:url value="/message/common/loadinboxmessages"/>">
					<s:message code="template00.messageInDetailForm.rightMenubarItem.back.LABEL"/>
				</a>
			</div>
		</td>
	</tr>
